...
const UserHeader = ({
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (navItem) {
        ...
        if (position) {
          navItem.classList.add("add-shadow");
        } else {
          navItem.classList.remove("add-shadow");
        }
      }
    };
  ...
  return (
    <header className={`w-full navbar-fixed`}>
      <div className="relative z-20 flex h-16 flex-shrink-0 border-b border-gray-200 bg-white">
        <button
          type="button"
        ...
        <Disclosure as="nav" className="flex justify-end w-full bg-userTheme navbar">
          <>
